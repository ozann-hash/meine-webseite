...
<head>
    ...
    <style>
        ...
        .star-rating label:hover ~ label {
            color: gold; /* Farbe der ausgewählten Sterne */
        }
    </style>
</head>
<body>
    ...
    <script>
        document.querySelectorAll('.star-rating input').forEach(input => {
            input.addEventListener('change', function() {
                alert('Sie haben ' + this.value + ' Sterne vergeben!');
            });
        });
    </script>
</body>
...
<head>
    <meta charset="UTF-8">
    <title>Fang das Objekt Spiel - Einfacher Modus</title>
    <style>
        #spielbereich {
        ...
        #objekt {
            ...
            border-radius: 50%;
            cursor: pointer;
            transition: top 0.5s ease, left 0.5s ease; /* Sanftere Bewegung */
        }
    </style>
</head>
<body>
